...
def _rename_banamex_merchant(description: str) -> str:
    ...
    cleanup_patterns = {
        ...
        r"^FEITO PORTUGAL(?: SA)?\b.*$": "Feito Portugal",
        r"^ENJOY VALUE\b.*$": "Enjoy Value",
        r"^THANKYOUMAMA\b.*$": "Thankyoumama",
        r"^ROTA GOURMET\b.*$": "Rota Gourmet",
        r"^HYGGE KAFFE\b.*$": "Hygge Kaffe",
        r"^CD R\.?C\.?SANCHES II\b.*$": "RC Sanches",
        r"^ASUR C CONV SHOP\b.*$": "Asur Conv Shop",
