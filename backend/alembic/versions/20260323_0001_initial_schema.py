...
def upgrade() -> None:
    ...
    if "statements" not in existing_tables:
        op.create_table(
            "statements",
...
def downgrade() -> None:
    # This migration also baselines legacy production tables created before
    # Alembic. Never drop those financial records during a downgrade to base.
    pass
